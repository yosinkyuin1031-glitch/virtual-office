...
export const departmentThemes: DepartmentTheme[] = [
  {
    ...
    members: [
      ...
      { name: 'ルカ', role: '書類・マニュアル・仕組み化＋採用業務（求人票・業務委託契約書・面接記録）', avatar: '📑' },
    ],
    apps: [],
    currentTasks: [
      'アプリ事業拡大戦略・統合プラン設計',
  ...
  },
  {
    ...
    apps: [
      { name: 'Clinic Core', url: 'https://customer-mgmt.vercel.app', status: 'active' },
  ...
  },
  {
    ...
    description: 'AI会社の収益中核。自社プロダクト（大口アプリラボ）と受託開発を明確に分離して管理。BtoB SaaS・AI製品の開発・販売・インフラ管理',
    manager: { name: 'テツ', avatar: '🤖' },
    members: [
      { name: 'テツ', role: 'BtoB SaaS戦略・プロダクト設計（自社プロダクト統括）', avatar: '🤖' },
      ...
      { name: 'ジュン', role: '受託開発リーダー（C-cure等クライアント案件の管理・納品・保守）', avatar: '📦' },
      { name: 'ナミ', role: 'データ分析（月次KPIダッシュボード・MRR/チャーン集計・Clinic Core/Stripe/Supabase統合）', avatar: '📈' },
    ],
    apps: [
  ...
  },
  {
    ...
    description: '治療家向けBtoB営業・モニター管理・提案書作成',
  ...
  },
  {
    id: 'research',
    name: 'リサーチ・ナレッジ部',
    englishName: 'Research & Knowledge',
    description: '5事業横断の市場/競合リサーチ・メンバーヒアリング記録・患者の声/治療家の声の継続収集と社内ナレッジ化。AI会社の情報基盤',
    manager: { name: 'セナ', avatar: '🔍' },
    members: [
      { name: 'セナ', role: 'リサーチ・ナレッジ部長（競合調査・市場トレンド統括・全社ナレッジ配信）', avatar: '🔍' },
      { name: 'リク', role: '市場・競合リサーチ専任（週次更新・5事業横断の競合マップ・トレンド収集）', avatar: '📚' },
      { name: 'チナ', role: 'ヒアリング記録担当（メンバーヒアリング・患者の声・治療家の声の整理とタグ付け）', avatar: '🎙️' },
    ],
    apps: [],
    currentTasks: [
  ...
  },
  {
    id: 'device_sales',
    name: '治療機器販売部',
    englishName: 'Medical Device Sales',
    description: 'ブレインリフレクション・血管顕微鏡のBtoB販売。見込み客管理・競合調査・デモ研修コンテンツ・他事業連携',
    manager: { name: 'ゴウ', avatar: '🔧' },
    members: [
      { name: 'ゴウ', role: '機器販売ディレクター（BR・血管顕微鏡・商談管理）', avatar: '🔧' },
      { name: 'カイ', role: '競合調査・差別化資料作成', avatar: '🔬' },
      { name: 'ソウ', role: 'デモ・研修コンテンツ・オンボーディング', avatar: '📹' },
    ],
    apps: [],
    currentTasks: [
      'BR 1件商談フォロー（2026-04-25結果判明予定）',
      '競合調査（BR・血管顕微鏡）と差別化資料作成',
      '知り合い経由以外の販売導線設計',
      '見込み客リスト管理・商談パイプライン可視化',
      '他事業（整体・コンサル・アプリ）とのクロスセル導線設計',
    ],
  ...
  },
  {
    id: 'consulting',
    name: 'コンサル事業部',
    englishName: 'Consulting Division',
    description: '川口村メンバー向け西村×大口グループコンサル（月1回コンサル＋LINE回答＋アプリ使用許可）の企画・運営・募集・コンテンツ制作',
    manager: { name: 'サトシ', avatar: '🧭' },
    members: [
      { name: 'サトシ', role: 'コンサル運営ディレクター（月1コンサル設計・進行）', avatar: '🧭' },
      { name: 'ミナト', role: '募集・LP・画像制作担当', avatar: '🖼️' },
      { name: 'リオ', role: 'コミュニティ運営・LINE回答サポート・オープンチャット管理', avatar: '💬' },
    ],
    apps: [],
    currentTasks: [
      '正式な事業名・ブランド名の決定支援',
      '募集用画像・LP作成（メンバーヒアリングのイメージをベースに）',
      '次期5名（月額11,000円）の募集準備',
      '月1回グループコンサル運営フロー整備',
      'LINE回答サポートテンプレート整備',
    ],
    lastActivity: '2026-04-11',
  ...
  },
  {
    id: 'ad_operations',
    name: '広告運用部',
    englishName: 'Ad Operations',
    description: '5事業横断の広告運用。Meta広告（Facebook/Instagram）・Google広告・YouTube広告の配信設定・予算管理・CVR改善・A/Bテスト。整体院・訪問鍼灸・アプリ販売が主な対象',
    manager: { name: 'ケイ', avatar: '📣' },
    members: [
      { name: 'ケイ', role: '広告運用ディレクター（Meta/Google/YouTube設定・予算管理・CVR改善）', avatar: '📣' },
      { name: 'ヒロ', role: 'クリエイティブ連携・A/Bテスト・数字集計', avatar: '📊' },
    ],
    apps: [],
    currentTasks: [
      '訪問鍼灸 Meta広告準備（Instagram整備と並行）',
      '整体院 四半期別症状LP連動のMeta広告設計',
