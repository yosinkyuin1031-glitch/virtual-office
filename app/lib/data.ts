...
ターゲット：神経整体実践者、ハリック勉強会メンバー、パートナーコミュニティ。`,
  },
  {
    ...
    currentTask: '5事業別競合マップ更新・治療家の秘密基地メンバーヒアリング記録整理',
...
月1回Zoom開催、録画をYouTubeで公開→次月のリード獲得に活用`,
  },
  {
    ...
    currentTask: '治療家の秘密基地のLINE回答・オープンチャット運営・メンバー交流促進',
...
ミナトと連携して募集画像制作、リオと連携してLINE回答サポート・オープンチャット運営を統括する。`,
  },
  {
    ...
    currentTask: '治療家の秘密基地 募集画像 A/B/C案 制作（Facebook 9:16）',
    skills: ['募集画像の企画・ディレクション', 'LP構成設計', 'メンバーヒアリング反映', 'Canva・画像ツール活用'],
    stats: { '画像案': 'A/B/C制作予定', '募集開始': '2026-05' },
    expertise: `【コンサル事業のブランディング・募集担当】
治療家の秘密基地の募集画像・LP制作を担当する。

【ブランド素材】
- 事業名: 治療家の秘密基地（2026-04-16確定）
- 命名の由来: メンバーヒアリングの言葉＋大口さん意向の「秘密基地」感から
...
- 結果はメモリ reference_competitor_map.md に蓄積`,
  },
  {
    ...
    currentTask: '治療家の秘密基地メンバーヒアリング記録の整理・タグ付け・コンサル募集ネタへの連携',
...
【対象データ】
- 治療家の秘密基地のメンバー発言（なおと/清本/水田/中越など）
- 整体院患者の声・口コミ・LINE相談
...
export const departments: Department[] = [
  ...
  },
  {
    ...
    borderColor: '#F9A825',
    manager: 'サトシ',
    description: '治療家の秘密基地（西村×大口グループコンサル）の企画・運営・募集・コンテンツ制作・LINE/オープンチャット管理',
