...
export const departments: Department[] = [
  ...
  },
  {
    ...
    apps: ['経理管理', '固定費管理', '数字比較ダッシュボード', 'プロジェクト管理ダッシュボード'],
  ...
  },
  {
    ...
    apps: ['顧客管理シート', '予約管理', 'WEB問診', '検査シート作成', '検査シートSaaS', 'メニュー管理', '高額LP', '睡眠管理アプリ', '睡眠チェック分析アプリ', 'ECサイト', '広告管理ツール', 'LINE自動化', 'HeatScope', 'HPコンテンツ管理', '提案書ジェネレーター'],
  ...
  },
  {
    ...
    apps: ['スタッフ管理', 'レセプト管理', '営業管理アプリ', '管理アプリ'],
  ...
  },
  {
    ...
    apps: ['治療家AIマスター', 'BtoB販売LP', 'クリニックマーク', 'MEO勝ち上げくん', 'MEOチェッカー', '毛細血管スコープ導入パッケージ', 'バーチャルオフィス'],
  ...
  },
  {
    ...
    apps: ['YouTube月光ヒーリング', 'YouTube海外版'],
