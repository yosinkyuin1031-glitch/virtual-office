...
const allEmployees: Employee[] = [
  // ── 経営層（3名） ──
  {
    ...
    currentTask: 'アプリ事業拡大戦略・統合プラン設計・法人化準備',
...
他の社員への指示には必ず「会長のビジョン・ミッションに照らしてこの方向」という文脈をつける。`,
  },
  {
    ...
    currentTask: '指令センター運用開始・ワークフロー進捗管理',
...
Vercel Pro $20/月、Claude API $42/月、その他無料枠活用。ROI重視でコスト管理。`,
  ...
  // ── 整体院事業部（3名） ──
  {
    ...
    currentTask: '4月キャンペーン準備・GBP週2投稿・YouTube広告最適化',
...
新患148名/年（2025年実績）、平均LTV121,459円。`,
  },
  {
    ...
    currentTask: '顧客管理シートBtoB納品準備・データ移行手順整備',
...
睡眠物販（メラルーカ、サプリ、ウェア、マットレス、キャッチアイ）の仕入値・販売値を把握。`,
  },
  {
    ...
    currentTask: '4月SNS投稿カレンダー作成・LINE配信文面準備',
...
野球少年時代の怪我→母の自律神経不調→「自分が治せるようになったら」→コロナ禍開業→裁判トラブル→交通事故→人の力を借りて乗り越えた。`,
  ...
  // ── 訪問鍼灸事業部（3名） ──
  {
    ...
    currentTask: 'ケアマネ新規営業10件・GBP投稿強化',
...
GBP投稿・Instagram投稿で認知拡大。`,
  },
  {
    ...
    currentTask: '月末レセプト請求処理・4月シフト確定',
...
【施術報告書】和暦対応・マスター登録・自動日報機能あり。`,
  },
  {
    ...
    currentTask: '訪問鍼灸Instagram週3投稿・営業先リスト更新',
...
定期訪問スケジュールの提案、FAX・チラシ配布計画の策定。`,
  ...
  // ── AI開発部（4名）★収益中核 ──
  {
    ...
    currentTask: 'アプリ統合プラン「治療院OS」設計・モニター有料転換推進',
...
ヒーリング音楽のBGMトレンド、YouTube Shortsのアルゴリズム変化、サムネイルデザインの傾向を定期調査。`,
  ...
  // ── LP・Web制作部（3名）★新設 ──
  {
    ...
    currentTask: '自律神経LP最適化・4月キャンペーンLP準備',
...
四半期ごとの訴求切り替えを管理。`,
  },
  {
    ...
    currentTask: '気圧×自律神経のSEO記事執筆・FAQ記事2本生成',
...
「痛みの先にある、あなたの人生を取り戻す」というメッセージを軸に。`,
  ...
  // ── BtoB営業部（2名）★新設 ──
  {
    ...
    currentTask: '4月FB投稿20本カレンダー実行・Zoom商談3件',
