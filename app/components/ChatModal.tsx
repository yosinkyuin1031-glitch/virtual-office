...
function getSuggestions(department: string): string[] {
  const map: Record<string, string[]> = {
    '経営層': ['今日やるべきことを整理して', '年商目標の進捗を報告して', '全社の課題を3つ挙げて'],
    '財務部': ['今月の収支を整理して', '物販の利益率を教えて', '来月のキャッシュフロー予測を出して'],
    '整体院事業部': ['GBP投稿を3本作って', 'LINE配信の文面を作って', '今の時期に効く症状訴求を提案して'],
    '訪問鍼灸事業部': ['ケアマネ向け営業資料を作って', 'Instagram投稿のネタを5つ出して', '新規営業先のリストを作って'],
    'AI開発部': ['BtoB販売の営業資料を作って', '検査アプリの差別化ポイントを整理して', 'SaaS化の次のステップは？'],
    'メディア部': ['YouTube投稿のタイトル案を出して', 'サムネイル改善案を出して', '次の動画テーマを提案して'],
    'LP・Web制作部': ['今の時期に合うLP訴求を提案して', 'SEO記事のテーマを5つ出して', '高額LPのコンバージョン改善案は？'],
    'BtoB営業部': ['Facebook投稿の下書きを作って', 'モニターの状況を報告して', '競合SaaSとの差別化ポイントは？'],
    '動画・デザイン制作部': ['チラシのデザイン案を出して', '広告動画の構成を提案して', 'Instagram画像のアイデアを5つ出して'],
  }
