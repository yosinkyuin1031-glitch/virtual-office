...
function getSuggestions(department: string): string[] {
  const map: Record<string, string[]> = {
    '経営層': ['今月のKPI進捗を教えて', '来月の優先タスクを整理して', '全社の課題を3つ挙げて'],
    '財務部': ['今月の収支を整理して', 'コスト削減できるポイントは？', '来月のキャッシュフロー予測を出して'],
    '整体院事業部': ['今週の予約状況は？', '顧客リピート率を改善する施策を提案して', 'LPのCVRを上げるアイデアを出して'],
    '訪問鍼灸事業部': ['今月の訪問件数の目標は？', '新規営業先のリストを作って', 'Instagram投稿のネタを5つ出して'],
    'マーケ・コンテンツ部': ['今月のGBP投稿を3本作って', 'SEO記事のキーワードを提案して', 'LINE配信の文面を作って'],
    'MEO事業部': ['MEOツールの新規顧客獲得策を考えて', '競合ツールとの差別化ポイントは？', '月額料金の見直し案を出して'],
    'EC事業部': ['今月の売上目標と進捗は？', '新商品のアイデアを出して', 'サブスク継続率を上げる施策は？'],
    'AI・技術開発部': ['サイトの稼働状況を報告して', '次に開発すべき機能は？', 'BtoB販売の営業資料を作って'],
    'メディア事業部': ['今月のYouTube再生数は？', 'サムネイル改善案を出して', '次に投稿すべき動画テーマは？'],
  }
